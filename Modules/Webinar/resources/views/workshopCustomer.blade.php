...
@section('title', 'Workshop Customers')
...
<h3>Workshop Customers</h3>
@endsection

@section('breadcrumb-items')
<li class="breadcrumb-item">{!! config('dashboard.name') !!}</li>
<li class="breadcrumb-item active">Workshop Customers</li>
@endsection
...
<script>
    $(document).on("init.dt", '#workshopCustomer-table', function() { // Ensures full page load
        let today = new Date();
        ...
        let table = $("#workshopCustomer-table").DataTable(); // Get existing DataTable instance
    ...
    function deleteCustomer(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url = "{{ route('manage.workshop.customer.delete', ':id') }}";
