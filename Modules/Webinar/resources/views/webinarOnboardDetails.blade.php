...
<li class="breadcrumb-item active">Onboard List</li>
@endsection
...
<script>
    $(document).on("init.dt",'#webinarOnboardDetails-table', function() { // Ensures full page load
        let today = new Date();
        ...
        let table = $("#webinarOnboardDetails-table").DataTable(); // Get existing DataTable instance
