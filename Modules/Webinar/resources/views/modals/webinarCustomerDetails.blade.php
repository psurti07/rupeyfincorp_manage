<div class="modal fade" id="viewWebinarUsers" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="viewWorkshopLeadsLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="viewWebinarUsersLabel">Customer &amp; Program Details</h5>
                        ...
                        <div class="card">
                            <div class="card-body my-card">
                                ...
                                <div class="text-end mt-4">
                                    <button class="btn btn-outline-warning me-2" id="accDeactivateBtn" data-userid="{{ $user->id }}">
                                        Deactivate Account
                                    </button>

                                    <button class="btn btn-outline-danger"  id="accDeleteBtn" data-userid="{{ $user->id }}">
                                        Delete Account
                                    </button>
                                </div>
                                @else
