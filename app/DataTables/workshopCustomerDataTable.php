...
class workshopCustomerDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('action', function ($row) {
                return '<button onclick="deleteCustomer(' . $row->id . ')" 
                            class="btn btn-icon btn-outline-danger btn-sm text-danger">
    ...
    {
        return $this->builder()
            ->setTableId('workshopCustomer-table')
    ...
    {
        return 'workshopCustomer_' . date('YmdHis');
    }
}
